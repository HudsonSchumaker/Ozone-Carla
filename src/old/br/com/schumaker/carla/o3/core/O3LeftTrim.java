 ...
 */
@Data
public final class O3LeftTrim implements IO3CoreFunction {

    public static final String O3STR_LEFT_TRIM = "o3ltrim";
    ...
    public O3LeftTrim() throws Exception {
        this(new O3SyntaxFunctionTable());
    }

    public O3LeftTrim(O3SyntaxFunctionTable functionTable) {
        this.o3Name = O3SyntaxFunctionTable.STR_L_TRIM;
    ...
    public void loadMethod() {
        this.coreNames.add("_" + O3STR_LEFT_TRIM);
        this.argTypeCoreNameMap.put(O3VariableType.STRING.getName(), O3STR_LEFT_TRIM);

        for (var name : coreNames) {
            this.signatureArgumentMap.put(name, 1);
        }

        this.signatureRegisterMap.put("_" + O3STR_LEFT_TRIM,
