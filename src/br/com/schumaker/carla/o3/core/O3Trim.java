 ...
 */
@Data
public final class O3Trim implements IO3CoreFunction {
    
    public static final String O3STR_TRIM = "o3trim";
    ...
    public O3Trim() throws Exception {
        this(new O3SyntaxFunctionTable());
    }

    public O3Trim(O3SyntaxFunctionTable functionTable) {
        this.o3Name = O3SyntaxFunctionTable.STR_TRIM;
    ...
    public void loadMethod() {
        this.coreNames.add("_" + O3STR_TRIM);
        this.argTypeCoreNameMap.put(O3VariableType.STRING.getName(), O3STR_TRIM);

        for (var name : coreNames) {
            this.signatureArgumentMap.put(name, 1);
        }

        this.signatureRegisterMap.put("_" + O3STR_TRIM,
