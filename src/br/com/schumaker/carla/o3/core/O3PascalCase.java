 ...
 */
@Data
public final class O3PascalCase implements IO3CoreFunction {
    ...
    public O3PascalCase(O3SyntaxFunctionTable functionTable) {
    ...
    public void loadMethod() {
        ...
        this.signatureRegisterMap.put("_" + O3STR_PASCAL_CASE,
